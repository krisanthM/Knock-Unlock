...
### Authentication Flow
1. Audio is recorded via a microphone  
2. Individual knock events are detected  
3. Time gaps between consecutive knocks are extracted  
4. The extracted rhythm is compared with a stored reference  
5. Access is granted or denied using tolerance-based matching  
...
1. Run enrollment  
2. Perform correct knock → ✅ GRANTED  
3. Perform incorrect knock → ❌ DENIED  

---

## 🏁 Conclusion

Knock Unlock demonstrates a secure, intuitive, and efficient authentication mechanism using rhythm-based knock patterns. By leveraging deterministic time-gap analysis instead of machine learning, the system achieves higher stability, better explainability, and real-time performance suitable for practical deployment.
